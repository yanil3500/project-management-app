...
public class ViewEditNotesForm extends JDialog {

    /**
     * Creates new form ViewEditNotesForm
     */
    public ViewEditNotesForm(JFrame parent, boolean modal, Task task) {
        super(parent, modal);
