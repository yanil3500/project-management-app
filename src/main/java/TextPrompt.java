...
/**
 * NOTE: This class was not written by us; We are using it so that we could display placeholder text in JTextFields.
 * Link: https://tips4java.wordpress.com/2009/11/29/text-prompt/
 */
